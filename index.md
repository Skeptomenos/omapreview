...
- Before OCR implementation: read the [opt-in OCRmyPDF waves in the shared plan](/home/david/.local/state/omapreview/coordination/review-remediation.md#opt-in-ocrmypdf--implementation-waves-2026-09-16). It owns batch scope, independent validation and dependencies on the active CLI/MCP work. [DEV-188](https://linear.app/helmus/issue/DEV-188/opt-in-ocrmypdf-integration-across-gui-cli-and-mcp) tracks the planned work; the [feasibility assessment](/home/david/.local/state/omapreview/coordination/evidence/ocr-feasibility/assessment.md) contains local OCR probes and limits.
