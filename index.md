...
- Before publishing or installing v0.2.0: [DEV-197](https://linear.app/helmus/issue/DEV-197/publish-and-install-omapreview-020) and the shared plan’s `release020` section own release acceptance and host installation. [Changelog](CHANGELOG.md) records shipped user-facing changes.
